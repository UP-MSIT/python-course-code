...
class CalcWinFrm:
    ...
    def __init__(self, win):
        ...
        self.lbl_calc = Label(win, text=' Calculator Application Tkinter UI', font=(
            'Arial', 16, 'bold'), fg='navy', bg='lightgrey', width=100, height=2, justify='center')
        self.lbl_1st_op = Label(win, text='First number', font=(
            'Arial', 10, 'bold'), bg='lightgrey', width=19)
        self.lbl_2nd_op = Label(win, text='Second number', font=(
            'Arial', 10, 'bold'), width=19)
        self.lbl_Results = Label(win, text='Results', font=(
            'Arial', 10, 'bold'), bg='lightgrey', width=19)

        # Create 3 Entry box in the window form
        self.entry_1st_num = Entry(width=14, font=('Arial', 14, 'normal'),
                                   justify='right')
        self.entry_2nd_num = Entry(width=14, font=('Arial', 14, 'normal'),
                                   justify='right')
        self.entry_result_num = Entry(
            width=14, font=('Arial', 14, 'bold'), justify='left')
        ...
        self.btn_div = Button(win, text='/', width=3, command=self.devi)
        ...
        self.btn_sub.place(x=220, y=150)
        self.btn_mul.place(x=290, y=150)
        self.btn_div.place(x=360, y=150)
...
WinFrm = Tk()
width = 655  # Set the Width of the window form
height = 200  # Set the Hight of the window form
